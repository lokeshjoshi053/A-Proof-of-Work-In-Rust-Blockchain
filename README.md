...
```bash
# Download the code
$ git clone https://github.com/lokeshjoshi053/A-Proof-of-Work-In-Rust-Blockchain
$ cd rust-blockchain
...
- [x] Transaction fees
- [x] Dynamic difficulty (aiming for constant time intervals between blocks)
- [x] Halving
- [x] Blockchain disk storage
- [x] Digital signing of transactions
